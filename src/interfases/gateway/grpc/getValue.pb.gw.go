...
/*
Package getCoordinate is a reverse proxy.
...
func request_CoordinateService_GetCoordinate_0(ctx context.Context, marshaler runtime.Marshaler, client CoordinateServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterCoordinateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CoordinateServiceClient) error {
	...
	mux.Handle("GET", pattern_CoordinateService_GetCoordinate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CoordinateService_GetCoordinate_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_CoordinateService_GetCoordinate_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_CoordinateService_GetCoordinate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"httpcordinate"}, ""))
)

var (
	forward_CoordinateService_GetCoordinate_0 = runtime.ForwardResponseMessage
)
